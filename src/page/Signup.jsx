...
const Signup = () => {
  ...
  const handleVerifyOtp = async (e) => {
    ...
    setError("");
    try {
      const response = await axios.post("http://localhost:8080/user/verify-email", {
        email,
        code: otp,
      });
  ...
  const handleSocialSignup = (provider) => {
    window.location.href = `http://localhost:8080/user/auth/${provider}`;
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-50 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-purple-600 mb-2" style={{ fontFamily: "Noto Sans KR, sans-serif" }}>
            HostPro
          </h1>
        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-purple-500 transition-colors text-center text-2xl tracking-widest"
                  placeholder="000000"
                  maxLength="6"
                  required
                />
          ...
          <div className="space-y-3">
            <button
              ...
              type="button"
              className="w-full py-3 bg-white border-2 border-gray-200 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center gap-3"
            >
